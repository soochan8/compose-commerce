...
//    val state by BaseViewModel.viewState
    ...
    LaunchedEffect(Unit) {
//        BaseViewModel.setEvent(HomeContract.Event.BannerLoad)
//        BaseViewModel.setEvent(HomeContract.Event.PopularItemLoad)
//        BaseViewModel.setEvent(HomeContract.Event.RankingCategoriesLoad)
    }
